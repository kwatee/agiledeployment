...
ALTER TABLE KWServerCredentials ALTER COLUMN password type VARCHAR(80);
ALTER TABLE KWServerCredentials ALTER COLUMN pem type VARCHAR(4000);
...
INSERT INTO KWApplicationParameter (id, schema_version, title, excluded_extensions) VALUES (0, '2.2.0', '<your organisation name here>', 'zip,bzip,gz,gzip,tar,tgz,bz2,bzip2,png,jpg,jpeg,gif,cab,img,iso,tif,tiff,bmp,exif,svg,pcf,pdf,mp3,mp4,mpeg,avi,aiff,wav,m4a,aac,ico,bin,so,a,o,exe,dll,Class,jar,war,ear');
