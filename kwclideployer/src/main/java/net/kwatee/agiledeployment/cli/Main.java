...
import net.kwatee.agiledeployment.cli.spring.ApplicationConfig;
...
public class Main {
	...
	public static void main(String[] args) throws KwateeException, IOException, ParserConfigurationException, SAXException {
		...
		try {
			...
			Deployer deployer = ctx.getBean(Deployer.class);

			Deployment deployment = deployer.loadDeployment(bundleXml, configurationXml, serverName, artifactName, forcedConduitType);
		...
		} catch (KwateeException ke) {
			System.err.println("Error: " + ke.getMessage());
